			...
			<div class="center-sign">
				...
				<div class="card">
					<div class="card-body">
						...
						<hr>
            <form class="user" method="post" action="<?php echo "$aksi?module=registrasi&act=input"; ?>">
              ...
              <div class="form-group mb-3">
                ...
                <input type="password" name="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password">
                  ...
                  <br>
							...
							<p class="text-center">Don't have an account yet? <a href="../../login.php">Login</a></p>
